...
headers = {
    "Ocp-Apim-Subscription-Key": "827da1e13c264d26ad648756834fb37c",
...
def analyze_text(text: Model):
    ...
    for i in range(no_of_text):
        ...
        sentiment = utils.call_text_analytics_api(headers, document,
                                                  endpoint='sentiment')
        keyphrases = utils.call_text_analytics_api(headers, document,
                                                   endpoint='keyPhrases')
